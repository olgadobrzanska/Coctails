...
CREATE SEQUENCE projekt.alergeny_id_alergeny_seq_1;

CREATE TABLE projekt.Alergeny (
                id_alergeny INTEGER NOT NULL DEFAULT nextval('projekt.alergeny_id_alergeny_seq_1'),
                nazwa VARCHAR NOT NULL,
...
ALTER SEQUENCE projekt.alergeny_id_alergeny_seq_1 OWNED BY projekt.Alergeny.id_alergeny;
...
CREATE SEQUENCE projekt.napoje_id_napoje_seq;

CREATE TABLE projekt.Napoje (
                id_napoje INTEGER NOT NULL DEFAULT nextval('projekt.napoje_id_napoje_seq'),
                nazwa VARCHAR NOT NULL,
...
ALTER SEQUENCE projekt.napoje_id_napoje_seq OWNED BY projekt.Napoje.id_napoje;

CREATE SEQUENCE projekt.alkohole_id_alkohole_seq;

CREATE TABLE projekt.Alkohole (
                id_alkohole INTEGER NOT NULL DEFAULT nextval('projekt.alkohole_id_alkohole_seq'),
                nazwa VARCHAR NOT NULL,
                cena NUMERIC(5,2) NOT NULL,
                kalorie INTEGER NOT NULL,
...
ALTER SEQUENCE projekt.alkohole_id_alkohole_seq OWNED BY projekt.Alkohole.id_alkohole;

CREATE SEQUENCE projekt.szklanki_id_szklanki_seq;

CREATE TABLE projekt.Szklanki (
                id_szklanki INTEGER NOT NULL DEFAULT nextval('projekt.szklanki_id_szklanki_seq'),
                nazwa VARCHAR NOT NULL,
...
ALTER SEQUENCE projekt.szklanki_id_szklanki_seq OWNED BY projekt.Szklanki.id_szklanki;
...
CREATE SEQUENCE projekt.skladniki_id_skladniki_seq;

CREATE TABLE projekt.Skladniki (
                id_skladniki INTEGER NOT NULL DEFAULT nextval('projekt.skladniki_id_skladniki_seq'),
                nazwa VARCHAR NOT NULL,
                kalorie INTEGER NOT NULL,
                cena NUMERIC(5,2) NOT NULL,
...
ALTER SEQUENCE projekt.skladniki_id_skladniki_seq OWNED BY projekt.Skladniki.id_skladniki;
